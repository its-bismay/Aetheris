    ...
    <div className="relative min-h-screen overflow-hidden bg-[#0A0A0A]" ref={containerRef}>
      ...
      <main className="relative z-10 flex flex-col items-center px-4 pb-24 pt-20 sm:px-6 lg:px-8">
        ...
        <section aria-labelledby="hero-heading" className="flex flex-col items-center text-center max-w-4xl mx-auto mb-24">
          ...
          >
            Stream model responses token-by-token, compare outputs across model versions, and test multimodal AI interactions with live metrics, diff visualization, and resilient streaming workflows.
          </motion.p>
          ...
          >
            <button className="group relative inline-flex items-center justify-center rounded-sm bg-[#6366F1] px-8 py-3 text-sm font-medium text-white transition-all hover:bg-[#4F52E1] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#6366F1] focus-visible:ring-offset-2 focus-visible:ring-offset-[#0A0A0A] overflow-hidden" onClick={() => window.location.href = '/playground'}>
              <span className="relative z-10 flex items-center">
                Open Playground <ChevronRight className="ml-2 h-4 w-4 transition-transform group-hover:translate-x-1" />
              </span>
            ...
            <button className="inline-flex items-center justify-center rounded-sm border border-[#262626] bg-[#121212] px-8 py-3 text-sm font-medium text-[#EDEDED] transition-colors hover:bg-[#1A1A1A] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#6366F1] focus-visible:ring-offset-2 focus-visible:ring-offset-[#0A0A0A]" onClick={() => window.location.href = '/diff-view'}>
              Compare Outputs
            </button>
          </motion.div>
        </section>
...
>
  <div className="relative w-full overflow-hidden rounded-xl border border-[#262626] bg-[#050505] shadow-2xl transition-transform duration-500 hover:scale-[1.01] group">

    <div className="absolute inset-0 bg-linear-to-br from-[#6366F1]/5 via-transparent to-transparent opacity-0 transition-opacity duration-500 group-hover:opacity-100 pointer-events-none" />
    ...
    <div className="flex items-center border-b border-[#262626] bg-[#121212] px-4 py-3">
      ...
      <div className="mx-auto flex h-6 items-center rounded-sm border border-[#262626] bg-[#0A0A0A] px-3">
        <span
          className="font-mono text-xs text-[#EDEDED]/50"
          aria-hidden="true"
        >
          api.aetheris.ai/v1/stream
        </span>
      </div>
    </div>

    <div className="relative h-[400px] overflow-hidden p-6 font-mono text-sm leading-relaxed text-[#EDEDED]/70">
      
      <div
        className="absolute top-0 left-0 flex h-full w-12 select-none flex-col items-center border-r border-[#262626] bg-[#0A0A0A] py-6 text-xs text-[#262626]"
        aria-hidden="true"
      >
        {[...Array(15)].map((_, i) => (
          <span key={i} className="mb-[6px]">
            {i + 1}
          </span>
        ))}
      </div>
      ...
      <div className="pl-10">
        <div className="text-[#8083ff]">
          export async function{" "}
          <span className="text-[#EDEDED]">streamInference</span>()
          {" {"}
        </div>
        ...
        <div className="mt-2 pl-4">
          ...
          <span className="text-[#8083ff]">const</span> reader = response.body
          ?.getReader();
          <br />

          <span className="text-[#8083ff]">const</span> decoder ={" "}
          <span className="text-[#8083ff]">new</span>{" "}
          <span className="text-[#EDEDED]">TextDecoder</span>();
          <br />
          <br />

          <span className="text-[#8083ff]">while</span> (
          <span className="text-amber-400/70">true</span>) {"{"}
          <br />

          <div className="pl-4">
            <span className="text-[#8083ff]">const</span> {"{ done, value }"} =
            <span className="text-[#8083ff]"> await</span> reader.read();
            <br />
            <br />

            <span className="text-[#8083ff]">if</span> (done){" "}
            <span className="text-[#8083ff]">break</span>;
            <br />
            <br />

            <span className="text-[#8083ff]">const</span> chunk =
            decoder.decode(value, {"{"} stream:{" "}
            <span className="text-amber-400/70">true</span> {"}"});
            <br />

            <span className="text-[#EDEDED]">onChunk</span>(chunk);
          </div>
      ...
      <div className="pointer-events-none absolute bottom-0 left-0 right-0 h-32 bg-linear-to-t from-[#050505] to-transparent" />
    </div>
  </div>
</motion.section>
        ...
        <section aria-labelledby="features-heading" className="w-full max-w-6xl mb-32">
          ...
          >
            ...
            <motion.div variants={fadeInUp} className="group flex flex-col rounded-xl border border-[#262626] bg-[#121212] p-8 transition-colors hover:border-[#464554] hover:bg-[#1A1C1C]">
              ...
              <p className="mb-8 text-sm text-[#EDEDED]/60 leading-relaxed">Stream model responses token-by-token using Fetch API and ReadableStream with live rendering, low-latency updates, and resilient error recovery.</p>
              ...
              <div className="mt-auto rounded-md border border-[#262626] bg-[#0A0A0A] p-4 font-mono text-xs" aria-hidden="true">
                ...
                <div className="text-[#EDEDED]">
                  ...
                  <span className="text-[#6366F1]">"model"</span>: <span className="text-emerald-400/70">"gemini-2.5-flash"</span>
                </div>
              </div>
            </motion.div>
            ...
            <motion.div variants={fadeInUp} className="group flex flex-col rounded-xl border border-[#262626] bg-[#121212] p-8 transition-colors hover:border-[#464554] hover:bg-[#1A1C1C]">
              ...
              <p className="mb-8 text-sm text-[#EDEDED]/60 leading-relaxed">Monitor live token throughput, tokens-per-second, latency, and streaming performance metrics while responses generate in real time.</p>
            ...
            <motion.div variants={fadeInUp} className="group flex flex-col rounded-xl border border-[#262626] bg-[#121212] p-8 transition-colors hover:border-[#464554] hover:bg-[#1A1C1C]">
              ...
              <p className="mb-8 text-sm text-[#EDEDED]/60 leading-relaxed">Switch seamlessly between text prompts and audio input with accessible controls, waveform feedback, and real-time AI interaction workflows.</p>
            ...
            <motion.div variants={fadeInUp} className="group flex flex-col rounded-xl border border-[#262626] bg-[#121212] p-8 transition-colors hover:border-[#464554] hover:bg-[#1A1C1C]">
              ...
              <p className="mb-8 text-sm text-[#EDEDED]/60 leading-relaxed">Compare model outputs using custom token-level diffing with inline change highlighting, edit tracking, and semantic response analysis.</p>
